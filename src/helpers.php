...
if (!function_exists('response_success')) {
    function response_success(mixed $data, int $status = 200, string|array|null $message = null)
    {
...
if (!function_exists('response_error')) {
    function response_error(int $status = 500, string|array|null $message = null)
    {
